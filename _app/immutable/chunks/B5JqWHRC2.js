...
Hit Squirrels until Jabber spawns
Prioritize Jabber
Kill Jabber, SE Manta, Cat, SW Manta, Squirrels, Yans`,imageUrl:`./m6s/adds/toxic-wave4.webp`}}},latte:{wave1:{MT:{role:`Tank`,party:1,description:`1. Pull boss and 2 squirrels east
2. Mitigate and AoE
...
5. After jabber is dead, focus Southeast ray.
6. Kill cat then Southwest ray.
7. Dodge lines, AoE rams.`,imageUrl:``}}},yukizuri:{wave1:{MT:{role:`Tank`,party:1,description:`Tank boss and Squirrels East`},OT:{role:`Tank`,party:2,description:`Tank Yan West`},H1:{role:`Healer`,party:1,description:`Stack on Yan to bait Cat jump
...
Take the tower furthest from river`,imageUrl:`./m6s/latte/pudding-422.webp`}]},{mechanic:`8-0-0`,description:`True North`,strats:[{role:`Tank`,party:1,description:`West`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Tank`,party:2,description:`Center South`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Healer`,party:1,description:`Close South East`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Healer`,party:2,description:`Center North`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Melee`,party:1,description:`Close South West`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Melee`,party:2,description:`Close North West`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Ranged`,party:1,description:`Far North East`,imageUrl:`./m6s/latte/pudding-800.webp`},{role:`Ranged`,party:2,description:`Far South East`,imageUrl:`./m6s/latte/pudding-800.webp`}]}]}]},l={stratName:`yukizuri`,description:`Source: Video by Yukizuri`,notes:``,stratUrl:`https://www.youtube.com/watch?v=3IXGB5fqC4A`,strats:[{phaseName:`Adds`,tag:`adds`,description:``,mechs:[{mechanic:`Wave 1`,strats:a(s,`wave1`)},{mechanic:`Wave 2`,strats:a(s,`wave2`)},{mechanic:`Wave 3`,strats:a(s,`wave3`)},{mechanic:`Wave 4`,strats:a(s,`wave4`)}]},{phaseName:`Under Construction`}]},u=[{stratName:`toxic`,description:`Source: Raidplan by Cute Animal @ Omega and Toxic Friends`,notes:``,stratUrl:{"Start + Adds":`https://raidplan.io/plan/Pgj53K49w8LAZpI6`,Desert:`https://raidplan.io/plan/NWiAOP4kdekXg9mg`,Bridges:`https://raidplan.io/plan/f0forhkOQMkVL3-I`},strats:[{phaseName:`Wingmark/Double Style`,mechs:[{mechanic:`Light Parties`,description:`G1 Left, G2 Right Facing Boss`,strats:[{role:`Tank`,party:1,description:`Left`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(31.4,13.14,8.8)},{role:`Tank`,party:2,description:`Right`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(13.02,28.94,8.8)},{role:`Healer`,party:1,description:`Left`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(31.4,13.14,8.8)},{role:`Healer`,party:2,description:`Right`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(13.02,28.94,8.8)},{role:`Melee`,party:1,description:`Left`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(31.4,13.14,8.8)},{role:`Melee`,party:2,description:`Right`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(13.02,28.94,8.8)},{role:`Ranged`,party:1,description:`Left`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(31.4,13.14,8.8)},{role:`Ranged`,party:2,description:`Right`,imageUrl:`./m6s/toxic/double-lps.webp`,mask:t(13.02,28.94,8.8)}]},{mechanic:`Partners`,strats:[{role:`Tank`,party:1,description:`Front with M1`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(24.62,24.35,8.8)},{role:`Tank`,party:2,description:`Back with M2`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(11.36,11.35,8.8)},{role:`Healer`,party:1,description:`Left with R1`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(41.09,9.32,8.8)},{role:`Healer`,party:2,description:`Right with R2`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(9.19,38.89,8.8)},{role:`Melee`,party:1,description:`Front with MT`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(24.62,24.35,8.8)},{role:`Melee`,party:2,description:`Back with OT`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(11.36,11.35,8.8)},{role:`Ranged`,party:1,description:`Left with H1`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(41.09,9.32,8.8)},{role:`Ranged`,party:2,description:`Right with H2`,imageUrl:`./m6s/toxic/double-partners.webp`,mask:t(9.19,38.89,8.8)}]}]},{phaseName:`Sticky Mousse`,mechs:[{mechanic:`Stacks`,description:`LP prio, use eyes`,imageUrl:`./m6s/toxic/sticky.webp`}]},{phaseName:`Cactus Dodges`,mechs:[{mechanic:`Stack + Short Defamations`,notes:`This is the only difference between Toxic and Hector strats`,description:`Toxic: Stack North, Tanks SW, DPS SE
Hector: Stack Mid, Tanks NW, DPS SW`,imageUrl:`./m6s/toxic/desert-dodges.webp`}]},{phaseName:`Quicksand + Healer Defamations`,description:`H1 CW, H2 CCW from cactus`,mechs:[{mechanic:`Party + Healer Defamations`,strats:[{role:`Tank`,party:1,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)},{role:`Tank`,party:2,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)},{role:`Healer`,party:1,description:`Clockwise from cactus corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(11.7,11.7,6)},{role:`Healer`,party:2,description:`Counter-Clockwise from cactus corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(88.5,87.4,6)},{role:`Melee`,party:1,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)},{role:`Melee`,party:2,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)},{role:`Ranged`,party:1,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)},{role:`Ranged`,party:2,description:`Across from unsafe corner`,imageUrl:`./m6s/toxic/desert-healers.webp`,mask:t(89.8,13.2,8)}]}]},{phaseName:`Quicksand + Bombs`,description:`True North
G1 W, G2 E, RMMR`,mechs:[{mechanic:`Bombs`,strats:[{role:`Tank`,party:1,description:`West close to boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(41.45,54.71,6)},{role:`Tank`,party:2,description:`East close to boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(59.69,54.58,6)},{role:`Healer`,party:1,description:`West far from boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(23.35,56.49,6)},{role:`Healer`,party:2,description:`East far from boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(79.97,57.9,6)},{role:`Melee`,party:1,description:`West close to boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(40.69,36.6,6)},{role:`Melee`,party:2,description:`East close to boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(60.07,36.48,6)},{role:`Ranged`,party:1,description:`West far from boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(19.9,37.12,6)},{role:`Ranged`,party:2,description:`East far from boss`,imageUrl:`./m6s/toxic/desert-bombs.webp`,mask:t(80.23,38.01,6)}]}]},{phaseName:`Adds`,tag:`adds`,description:``,mechs:[{mechanic:`Wave 1`,strats:a(s,`wave1`)},{mechanic:`Wave 2`,strats:a(s,`wave2`)},{mechanic:`Wave 3`,strats:a(s,`wave3`)},{mechanic:`Wave 4`,strats:a(s,`wave4`)}]},{phaseName:`Sugarscape (River)`,description:``,mechs:[{mechanic:`Lightning (Spreads)`,description:``,strats:[{role:`Tank`,party:1,description:`Northwest`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([16.39,51.39,7],[69.71,42.47,7])},{role:`Tank`,party:2,description:`Northwest`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([10.72,21.81,7],[59.63,19.26,7])},{role:`Healer`,party:1,description:`Northeast`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([42.66,29.21,7],[86.29,15.31,7])},{role:`Healer`,party:2,description:`South`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([13.91,83.91,7],[70.03,75.24,7])},{role:`Melee`,party:1,description:`Northwest`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([17.35,34.05,7],[59.82,42.09,7])},{role:`Melee`,party:2,description:`Northwest`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([26.47,32.78,7],[69.52,19.01,7])},{role:`Ranged`,party:1,description:`Northeast`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([42.44,53.31,7],[85.71,45.53,7])},{role:`Ranged`,party:2,description:`South`,imageUrl:`./m6s/toxic/river-lightning.webp`,mask:n([28.12,84.17,7],[83.93,76.77,7])}]},{mechanic:`Fire (Stacks)`,description:``,strats:[{role:`Tank`,party:1,description:`Middle`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([28.32,54.57,10],[74.4,46.3,10])},{role:`Tank`,party:2,description:`Far behind safe bridge`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([11.54,59.8,10],[57.9,68.37,10])},{role:`Healer`,party:1,description:`Middle`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([28.32,54.57,10],[74.4,46.3,10])},{role:`Healer`,party:2,description:`Far behind safe bridge`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([11.54,59.8,10],[57.9,68.37,10])},{role:`Melee`,party:1,description:`Middle`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([28.32,54.57,10],[74.4,46.3,10])},{role:`Melee`,party:2,description:`Middle`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([28.32,54.57,10],[74.4,46.3,10])},{role:`Ranged`,party:1,description:`Far behind safe bridge`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([11.54,59.8,10],[57.9,68.37,10])},{role:`Ranged`,party:2,description:`Far behind safe bridge`,imageUrl:`./m6s/toxic/river-fire.webp`,mask:n([11.54,59.8,10],[57.9,68.37,10])}]}]},{phaseName:`Lightning Storm`,description:`Party stays on bridge
...
Take West tower closest to wall`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(33.2,85.1,8)},{role:`Tank`,party:2,description:`Bait proteans
Take East tower closest to wall`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(62.9,86,8)},{role:`Healer`,party:1,description:`West platform
Take the tower closer to the middle`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(34.8,39.6,8)},{role:`Healer`,party:2,description:`East platform
Take the tower closer to the middle`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(69.9,38.7,8)},{role:`Melee`,party:1,description:`Bait proteans
Take West tower near marker`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(35,69.4,8)},{role:`Melee`,party:2,description:`Bait proteans
Take East tower near marker`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(62.3,70.9,8)},{role:`Ranged`,party:1,description:`West platform
Take the tower further from the middle`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(16.1,52.9,8)},{role:`Ranged`,party:2,description:`East platform
Take the tower further from the middle`,imageUrl:`./m6s/toxic/pudding-towers.webp`,mask:t(85.9,33.9,8)}]}]},{phaseName:`Wingmark + Towers`,description:`Melees + Tanks in the 4 tower platform
Everyone rotate the same direction`,mechs:[{mechanic:`4-2-2`,description:`Healers + Melees closest to river`,strats:[{role:`Tank`,party:1,description:`Take Left tower furthest from river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(85.8,15.2,8)},{role:`Tank`,party:2,description:`Take Right tower furthest from river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(87.6,59.6,8)},{role:`Healer`,party:1,description:`Left platform
Take the tower closest to river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(59.6,72.3,8)},{role:`Healer`,party:2,description:`Right platform
Take the tower closest to river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(28.2,43.8,8)},{role:`Melee`,party:1,description:`Take Left tower closest to river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(71.6,26.6,8)},{role:`Melee`,party:2,description:`Take Right tower closest to river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(72.4,44.6,8)},{role:`Ranged`,party:1,description:`Left platform
Take the tower furthest from river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(29.5,86.1,8)},{role:`Ranged`,party:2,description:`Right platform
Take the tower furthest from river`,imageUrl:`./m6s/toxic/pudding-422.webp`,mask:t(16.6,22.9,8)}]},{mechanic:`8-0-0`,description:`Static positions`,strats:[{role:`Tank`,party:1,description:`Far West`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(12.6,83.7,8)},{role:`Tank`,party:2,description:`Center South`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(46.3,84.8,8)},{role:`Healer`,party:1,description:`Close Southeast`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(63.3,86.2,8)},{role:`Healer`,party:2,description:`Center North`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(46.7,68.6,8)},{role:`Melee`,party:1,description:`Close Southwest`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(29.5,86.1,8)},{role:`Melee`,party:2,description:`Close Northwest (near 4 marker)`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(28,70,8)},{role:`Ranged`,party:1,description:`Far East`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(79.3,83.9,8)},{role:`Ranged`,party:2,description:`Close Northeast (near 3 marker)`,imageUrl:`./m6s/toxic/pudding-800.webp`,mask:t(66.1,69.9,8)}]}]}]},{stratName:`game8`,description:`Source: Game8`,notes:``,stratUrl:`https://game8.jp/ff14/681086`,strats:[{phaseName:`Wingmark/Double Style`,mechs:[{mechanic:`Light Parties`,description:`G1 Left, G2 Right Facing Boss`,strats:[{role:`Tank`,party:1,description:`Left`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Tank`,party:2,description:`Right`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Healer`,party:1,description:`Left`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Healer`,party:2,description:`Right`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Melee`,party:1,description:`Left`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Melee`,party:2,description:`Right`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Ranged`,party:1,description:`Left`,imageUrl:`./m6s/game8/double-lps.webp`},{role:`Ranged`,party:2,description:`Right`,imageUrl:`./m6s/game8/double-lps.webp`}]},{mechanic:`Partners`,strats:[{role:`Tank`,party:1,description:`Front with D1`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Tank`,party:2,description:`Back with D2`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Healer`,party:1,description:`Left with D3`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Healer`,party:2,description:`Right with D4`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Melee`,party:1,description:`Front with MT`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Melee`,party:2,description:`Back with ST`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Ranged`,party:1,description:`Left with H1`,imageUrl:`./m6s/game8/double-partners.webp`},{role:`Ranged`,party:2,description:`Right with H2`,imageUrl:`./m6s/game8/double-partners.webp`}]}]},{phaseName:`Sticky Mousse`,mechs:[{mechanic:`Stacks`,description:`Modified clocks, Tanks stack center`,imageUrl:`./m6s/game8/sticky.webp`}]},{phaseName:`Cactus Dodges`,mechs:[{mechanic:`Stack + Short Defamations`,description:`Stack North`}]},{phaseName:`Quicksand + Healer Defamations`,description:`H1 NW, H2 SE, Party NE
